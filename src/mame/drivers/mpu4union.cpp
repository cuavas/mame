...
GAME(199?, m4cwalk,   0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union","Cake Walk (Union) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4eezee,   0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union","Eezee Fruits (Union) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4frdrop,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union","Fruit Drop (Union) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4gobana,  0,        mpu4, mpu4_mod2_state,    m4default, ROT0,   "Union","Go Bananas (Union) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4gobanaa, m4gobana, mpu4, mpu4_mod2_state,    m4default, ROT0,   "Union","Go Bananas (Union) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4gobanab, m4gobana, mpu4, mpu4_mod2_state,    m4default, ROT0,   "Union","Go Bananas (Union) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4gobanac, m4gobana, mpu4, mpu4_mod2_state,    m4default, ROT0,   "Union","Go Bananas (Union) (MPU4, set 4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4gobanad, m4gobana, mpu4, mpu4_mod2_state,    m4default, ROT0,   "Union","Go Bananas (Union) (MPU4, set 5)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4lotty,   0,        mpu4, mpu4_mod2_state,    m4default, ROT0,   "Union","Lotty Time (Union) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4maxmze,  0,        mpu4, mpu4_mod2_state,    m4default, ROT0,   "Union","Maximize (Union) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4maxmzea, m4maxmze, mpu4, mpu4_mod2_state,    m4default, ROT0,   "Union","Maximize (Union) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4maxmzeb, m4maxmze, mpu4, mpu4_mod2_state,    m4default, ROT0,   "Union","Maximize (Union) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4maxmzec, m4maxmze, mpu4, mpu4_mod2_state,    m4default, ROT0,   "Union","Maximize (Union) (MPU4, set 4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4maxmzed, m4maxmze, mpu4, mpu4_mod2_state,    m4default, ROT0,   "Union","Maximize (Union) (MPU4, set 5)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4mecca,   0,        mpu4, mpu4_mod2_state,    m4default, ROT0,   "Union","Mecca Money (Union) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4purmad,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union","Pure Madness (Union)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4revolv,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union","Revolva (Union) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4rotex,  0,         mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union","Rotex (Union) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4select, 0,         mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union","Select (Union) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4supfru, 0,         mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union","Supafruits (Union) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4supfrua,m4supfru,  mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union","Supafruits (Union) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4trimad, 0,         mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union","Triple Madness (Union) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4unibox, 0,         mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union","Unibox (Union) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4uniboxa,m4unibox,  mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union","Unibox (Union) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4unique, 0,         mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union","Unique (Union) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4uniquep,m4unique,  mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union","Unique (Union) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4crzbn,  0,         mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union","Crazy Bingo (Union) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
/* Union + Empire
   same as Union above */
GAME(199?, m4gvibes,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union / Empire","Good Vibrations (Union - Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4gvibesa, m4gvibes, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union / Empire","Good Vibrations (Union - Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4rckrol,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union / Empire","Rock 'n' Roll (Union - Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4rckrola, m4rckrol, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union / Empire","Rock 'n' Roll (Union - Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4rckrolb, m4rckrol, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Union / Empire","Rock 'n' Roll (Union - Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
