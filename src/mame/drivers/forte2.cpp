...
MACHINE_CONFIG_START(forte2_state::device_add_mconfig)
...
GAME( 1989, pesadelo, 0, pesadelo, forte2_state, pesadelo, ROT0, "bootleg (Forte II Games) / Konami", "Pesadelo (bootleg of Knightmare on MSX)", MACHINE_SUPPORTS_SAVE )
