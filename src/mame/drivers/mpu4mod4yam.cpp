...
DRIVER_INIT_MEMBER( mpu4_mod4yam_state, m4_debug_mod4yam )
{
...
DRIVER_INIT_MEMBER( mpu4_mod4yam_state, m4_showstring_mod4yam )
{
...
GAME(198?, m4tst,        0, mpu4 , mpu4_mod4yam_state,m4default,     ROT0,"Barcrest","MPU4 Unit Test (Program 4)",MACHINE_MECHANICAL )
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	...
	ROM_END \
	GAME(year, setname, parent ,mpu4 , mpu4_mod4yam_state,m4_showstring ,ROT0,company,title,GAME_FLAGS )
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		ROM_LOAD( name, offset, length, hash ) \
	ROM_END \
	GAMEL(year, setname, parent ,mpu4 , mpu4_mod4yam_state,m4gambal ,ROT0,company,title,MACHINE_REQUIRES_ARTWORK|MACHINE_MECHANICAL,layout_gamball )
...
GAME(199?, m4stc    ,0          ,mpu4               , mpu4_mod4yam_state,m4default          ,ROT0,   "Barcrest","unknown MPU4 'STC 0.1' (Barcrest) (MPU4)",GAME_FLAGS)
GAME(199?, m4sstrek ,m4supst    ,mpu4               , mpu4_mod4yam_state,m4default          ,ROT0,   "bootleg","Super Streak (bootleg) (MPU4)",GAME_FLAGS)
GAME(199?, m4joljokd,m4joljok   ,mpu4               , mpu4_mod4yam_state,m4default          ,ROT0,   "Barcrest","Jolly Joker (Barcrest) [Dutch] (MPU4) (DJJ)",GAME_FLAGS)
GAME(199?, m4clbshf ,0          ,mpu4               , mpu4_mod4yam_state,m4default          ,ROT0,   "Barcrest","Club Shuffle (Barcrest) (MPU4)",GAME_FLAGS) // set stake
GAME(199?, m4voodoo ,0          ,mpu4               , mpu4_mod4yam_state,m4altreels         ,ROT0,   "Barcrest","Voodoo 1000 (Barcrest) (Dutch) (MPU4) (DDO 3.2)",GAME_FLAGS )
GAME(199?, m4graffd ,m4graff    ,mpu4               , mpu4_mod4yam_state,m4default          ,ROT0,   "Barcrest","Grafitti (Barcrest) [Dutch] (MPU4)",GAME_FLAGS )
