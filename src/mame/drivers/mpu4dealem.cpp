...
MACHINE_CONFIG_START(mpu4dealem_state::device_add_mconfig)
...
GAME(  1987,v4dealem,   0,          dealem, mpu4dealem_state,      0,          ROT0, "Zenitone","Deal 'Em (MPU4 Conversion Kit, v7.0)",MACHINE_IMPERFECT_GRAPHICS )
