...
DRIVER_INIT_MEMBER(mpu4_mod4oki_state,m4andycp)
{
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4ANDYCP_EXTRA_ROMS \
	ROM_END \
	GAMEL(year, setname, parent ,mpu4 , mpu4_mod4oki_state,m4andycp,ROT0,company,title,GAME_FLAGS, layout_m4andycp )
...
GAME( 1994, m4andycp10c,  m4andycp,  mpu4, mpu4_mod4oki_state, m4_andycp10c , ROT0, "Bwb", "Andy Capp (Bwb / Barcrest) (MPU4) (AC10C)",GAME_FLAGS )
...
GAME(199?, m4andycpdut,     m4andycp    ,mpu4               , mpu4_mod4oki_state,m4_showstring          ,ROT0,   "Barcrest","Andy Capp (Barcrest) [DAC 1.3, Dutch] (MPU4)",         GAME_FLAGS|MACHINE_NO_SOUND )
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4ANDYFL_EXTRA_ROMS \
	ROM_END \
	GAME(year, setname, parent ,mpu4 , mpu4_mod4oki_state,m4_showstring,ROT0,company,title,GAME_FLAGS )
...
DRIVER_INIT_MEMBER(mpu4_mod4oki_5r_state,m4andyge)
{
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4ANDYGE_EXTRA_ROMS \
	ROM_END \
	GAMEL(year, setname, parent ,grtecp , mpu4_mod4oki_5r_state,m4andyge ,ROT0,company,title,GAME_FLAGS, layout_m4andyge )
...
DRIVER_INIT_MEMBER(mpu4_mod2_state,m4addr)
{
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		ROM_LOAD( name, offset, length, hash ) \
	ROM_END \
	GAMEL(year, setname, parent ,mpu4 , mpu4_mod2_state,m4addr ,ROT0,company,title,GAME_FLAGS, layout_m4addr )
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4ADDRCC_EXTRA_ROMS \
	ROM_END \
	GAME(year, setname, parent ,mpu4 , mpu4_mod2_state,m4_showstring ,ROT0,company,title,GAME_FLAGS )
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4CRMAZE_EXTRA_ROMS \
	ROM_END \
	GAME(year, setname, parent ,mpu4jackpot8tkn , mpu4_mod4oki_state,m4_showstring_big ,ROT0,company,title,GAME_FLAGS )
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4TOPTEN_EXTRA_ROMS \
	ROM_END \
	GAME(year, setname, parent ,mpu4 , mpu4_mod4oki_state,m4_showstring_big ,ROT0,company,title,GAME_FLAGS )
...
GAME(199?, m4eaw__bz, m4eaw ,mpu4 , mpu4_mod4oki_state,m4_showstring ,ROT0,"Barcrest","Everyone's A Winner (Barcrest) (MPU4) (unknown rev, bad)",GAME_FLAGS )
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4MAG7S_EXTRA_ROMS \
	ROM_END \
	GAME(year, setname, parent ,mpu4jackpot8per , mpu4_mod4oki_state,m4_showstring_big ,ROT0,company,title,GAME_FLAGS )
...
DRIVER_INIT_MEMBER(mpu4_mod4oki_state,m4tenten)
{
	DRIVER_INIT_CALL(m4default);
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4TENTEN_EXTRA_ROMS \
	ROM_END \
	GAMEL(year, setname, parent ,mpu4 , mpu4_mod4oki_state,m4tenten ,ROT0,company,title,GAME_FLAGS, layout_m4tenten )
...
DRIVER_INIT_MEMBER(mpu4_mod4oki_state,m4andyfh)
{
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4ANDYFH_EXTRA_ROMS \
	ROM_END \
	GAMEL(year, setname, parent ,mpu4 , mpu4_mod4oki_state,m4andyfh ,ROT0,company,title,GAME_FLAGS, layout_m4andyfh )
...
DRIVER_INIT_MEMBER(mpu4_mod4oki_state,m4actbnk)
{
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4ACTBNK_EXTRA_ROMS \
	ROM_END \
	GAMEL(year, setname, parent ,mpu4 , mpu4_mod4oki_state,m4actbnk ,ROT0,company,title,GAME_FLAGS, layout_m4actbnk )
...
DRIVER_INIT_MEMBER(mpu4_mod4oki_state,m4andybt)
{
	DRIVER_INIT_CALL(m4default_big);
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4ANDYBT_EXTRA_ROMS \
	ROM_END \
	GAMEL(year, setname, parent ,mpu4 , mpu4_mod4oki_state,m4andybt ,ROT0,company,title,GAME_FLAGS, layout_m4andybt )
