...
MACHINE_CONFIG_START(lynx_state::device_add_mconfig)
...
CONS( 1989, lynx,   0,      0,      lynx, lynx_state,   0,      "Atari",  "Lynx",       MACHINE_SUPPORTS_SAVE )
// CONS( 1991, lynx2,  lynx,  0,      lynx, lynx2_state,  0,      "Atari",  "Lynx II",    MACHINE_NOT_WORKING | MACHINE_IMPERFECT_SOUND )
