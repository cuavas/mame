...
MACHINE_CONFIG_START(skyraid_state::device_add_mconfig)
...
GAME( 1978, skyraid, 0, skyraid, skyraid_state, 0, ORIENTATION_FLIP_Y, "Atari", "Sky Raider", MACHINE_IMPERFECT_COLORS )
