...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4DCRLS_EXTRA_ROMS \
	ROM_END \
	GAME(year, setname, parent ,mpu4 , mpu4_mod4oki_state,m4default_big ,ROT0,company,title,GAME_FLAGS )
...
//This rom is possibly bad, data content isn't multiple of 0x800, padding with low bits rather than high
	ROM_START( m4shkwav__c )
		...
		M4SHKWAV_EXTRA_ROMS
	ROM_END
GAME(199?, m4shkwav__c, m4shkwav ,mpu4 , mpu4_mod4oki_state,m4default_big ,ROT0,"Qps","Shockwave (Qps) (MPU4) (set 4)",GAME_FLAGS )
...
GAME(199?, m4bangin,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Global","Bangin' Away (Global) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4bangina, m4bangin, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Global","Bangin' Away (Global) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4banginb, m4bangin, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Global","Bangin' Away (Global) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4wwc,     0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Global","Wacky Weekend Club (Global) (MPU4) (set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4wwca,    m4wwc,    mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Global","Wacky Weekend Club (Global) (MPU4) (set 2)" ,   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4wwcb,    m4wwc,    mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Global","Wacky Weekend Club (Global) (MPU4) (set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4screw,   0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Global","Screwin' Around (Global) (MPU4, v0.8)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4screwp,  m4screw,  mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Global","Screwin' Around (Global) (MPU4, v0.8) (Protocol)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4screwa,  m4screw,  mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Global","Screwin' Around (Global) (MPU4, v0.7)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4screwb,  m4screw,  mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Global","Screwin' Around (Global) (MPU4, v0.5)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4vfm,     0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Global","Value For Money (Global) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4jiggin,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Global","Jiggin' In The Riggin' (Global) (MPU4) (set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4jiggina, m4jiggin, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Global","Jiggin' In The Riggin' (Global) (MPU4) (set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
