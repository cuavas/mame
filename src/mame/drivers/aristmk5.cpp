...
class aristmk5_touch_state : public aristmk5_state
{
protected:
	using aristmk5_state::aristmk5_state;
	virtual void device_add_mconfig(machine_config &config) override;
};


class aristmk5_usa_state : public aristmk5_state
{
public:
	using aristmk5_state::aristmk5_state;
...
class aristmk5_usa_touch_state : public aristmk5_usa_state
{
protected:
	using aristmk5_usa_state::aristmk5_usa_state;
	virtual void device_add_mconfig(machine_config &config) override;
};
...
WRITE8_MEMBER(aristmk5_usa_state::rtc_usa_w)
{
...
WRITE8_MEMBER(aristmk5_usa_state::eeprom_usa_w)
{
...
ADDRESS_MAP_START(aristmk5_usa_state::aristmk5_usa_map)
...
CUSTOM_INPUT_MEMBER(aristmk5_usa_state::coin_usa_r)
{
	//  ---x  Coin Acceptor
	//  --x-  Credit Sense
	//  -x--  Error Signal
...
static INPUT_PORTS_START( aristmk5_usa )
	...
	PORT_START("P4")
	PORT_BIT(0x00000078, IP_ACTIVE_HIGH, IPT_SPECIAL) PORT_CUSTOM_MEMBER(DEVICE_SELF, aristmk5_usa_state, coin_usa_r, nullptr)
...
MACHINE_CONFIG_START(aristmk5_state::device_add_mconfig)
...
MACHINE_CONFIG_START(aristmk5_touch_state::device_add_mconfig)
	aristmk5_state::device_add_mconfig(config);
...
MACHINE_CONFIG_START(aristmk5_usa_state::device_add_mconfig)
	aristmk5_state::device_add_mconfig(config);
	MCFG_CPU_MODIFY("maincpu")
	MCFG_CPU_PROGRAM_MAP(aristmk5_usa_map)
MACHINE_CONFIG_END

MACHINE_CONFIG_START(aristmk5_usa_touch_state::device_add_mconfig)
	aristmk5_usa_state::device_add_mconfig(config);
	MCFG_DEVICE_MODIFY("uart_0a")
	MCFG_INS8250_OUT_TX_CB(DEVWRITELINE("microtouch", microtouch_device, rx))
...
GAMEL( 1995, aristmk5,    0,        aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "MKV Set/Clear Chips (USA)",                            MACHINE_FLAGS|MACHINE_IS_BIOS_ROOT, layout_aristmk5_us )

// Dates listed below are for the combination (reel layout), not release dates
GAMEL( 1998, adonis,      aristmk5, aristmk5,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Adonis (0200751V, NSW/ACT)",                           MACHINE_FLAGS, layout_aristmk5 )        // 602/9, A - 25/05/98, Rev 10
GAMEL( 1998, adonisa,     adonis,   aristmk5,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Adonis (0100751V, NSW/ACT)",                           MACHINE_FLAGS, layout_aristmk5 )        // 602/9, A - 25/05/98, Rev 9
GAMEL( 1999, adonisce,    adonis,   adonisce,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Adonis - Cash Express (0201005V, NSW/ACT)",            MACHINE_FLAGS, layout_aristmk5 )        // 602/9, C - 06/07/99, Rev 12
GAMEL( 2001, adonisu,     adonis,   bootsctnua,   aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Adonis (BHG1508, US)",                                 MACHINE_FLAGS, layout_adonisu )         // MV4124/1, B - 31/07/01
GAMEL( 2002, alchemst,    aristmk5, goldenra,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Alchemist (01J02046, Venezuela)",                      MACHINE_FLAGS, layout_yukongl5 )        // JB013/1, A - 22/01/02, Rev 17
GAMEL( 2000, bparty,      aristmk5, bootsctnua,   aristmk5_usa_touch_state, aristmk5, ROT0, "Aristocrat", "Bachelorette Party (BHG1248, US)",                     MACHINE_FLAGS, layout_bparty )          // MV4119/1, B - 25/08/2000
GAMEL( 1996, baddog,      aristmk5, baddog,       aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Bad Dog Poker (0200428V, NSW/ACT)",                    MACHINE_FLAGS, layout_baddog )          // 386/56, A - 17/12/96
GAMEL( 1998, bootsctn,    aristmk5, cashcham,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Boot Scootin' (0100812V, NSW/ACT)",                    MACHINE_FLAGS, layout_cashcham )        // 616/1, B - 11/12/98, Rev 20
GAMEL( 1999, bootsctnu,   bootsctn, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Boot Scootin' (GHG1012-02, US)",                       MACHINE_FLAGS, layout_aristmk5_us )     // MV4098, A - 25/08/99
GAMEL( 1999, bootsctnua,  bootsctn, pengpuck,     aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Boot Scootin' (GHG1008-03, US)",                       MACHINE_FLAGS, layout_aristmk5_us_200 ) // MV4098/1, A - 27/07/99
GAMEL( 2001, bootsctnub,  bootsctn, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Boot Scootin' (AHG1547, US)",                          MACHINE_FLAGS, layout_adonisu )         // MV4098/1, B - 22/03/01
GAMEL( 1996, bumblbug,    aristmk5, bumblbug,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Bumble Bugs (0200510V, NSW/ACT)",                      MACHINE_FLAGS, layout_bumblbug )        // 593, D - 5/07/96, Rev 3
GAMEL( 1996, bumblbugql,  bumblbug, swhr2,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Bumble Bugs (0200456V, Queensland)",                   MACHINE_FLAGS, layout_swhr2 )           // 593, D - 5/07/96, Rev 1.0
GAMEL( 1997, bumblbugu,   bumblbug, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Bumble Bugs (CHG0479-03, US)",                         MACHINE_FLAGS, layout_aristmk5_us )     // 593, D - 05/07/97
GAMEL( 1997, bumblbugua,  bumblbug, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Bumble Bugs (CHG0479-99, US)",                         MACHINE_FLAGS, layout_aristmk5_us )     // 593, D - 05/07/97
GAMEL( 1995, buttdeli,    aristmk5, swhr2,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Butterfly Delight (0200143V, NSW/ACT)",                MACHINE_FLAGS, layout_swhr2 )           // 571/4, A - 19/12/95, Rev 1.8.1.0
GAMEL( 1998, cashcat,     aristmk5, aristmk5,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Cash Cat (0100676V, NSW/ACT)",                         MACHINE_FLAGS, layout_aristmk5 )        // 614/3, A - 03/04/98, Rev 7
GAMEL( 1997, cashcata,    cashcat,  aristmk5_9,   aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Cash Cat (0100557V, NSW/ACT)",                         MACHINE_FLAGS, layout_dolphntrb )       // 614/1, B - 01/12/97, Rev 7
GAMEL( 1999, cashcatnz,   cashcat,  cashcatnz,    aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Cash Cat (0300863V, New Zealand)",                     MACHINE_FLAGS, layout_cashcatnz )       // MV4089, A - 4/1/99, Rev 26
GAMEL( 1997, cashcham,    aristmk5, cashcham,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Cash Chameleon (0100438V, NSW/ACT)",                   MACHINE_FLAGS, layout_cashcham )        // 603/1, C  - 15/4/97, Rev 1.25.3.0
GAMEL( 1998, cashchama,   cashcham, cashchama,    aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Cash Chameleon (0200437V, NSW/ACT)",                   MACHINE_FLAGS, layout_cashchama )       // 603(a), D - 18/02/98, Rev 3
GAMEL( 1998, cashchamnz,  cashcham, cashchamnz,   aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Cash Chameleon (0300781V, New Zealand)",               MACHINE_FLAGS, layout_cashchamnz )      // MV4067, A - 31/08/98, Rev 21
GAMEL( 1996, cashchamu,   cashcham, bootsctnua,   aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Cash Chameleon (DHG4078-99, US)",                      MACHINE_FLAGS, layout_cashchamu )       // 603(a), B - 06/12/96
GAMEL( 1997, cashcra5,    aristmk5, aristmk5,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Cash Crop (0300467V, NSW/ACT)",                        MACHINE_FLAGS, layout_aristmk5 )        // 607, C - 14/07/97, Rev 6
GAMEL( 1998, chariotc,    aristmk5, chariotc,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "The Chariot Challenge (0100787V, NSW/ACT)",            MACHINE_FLAGS, layout_aristmk5 )        // 630/1, A - 10/08/98, Rev 11
GAMEL( 1998, chariotcv,   chariotc, chariotcv,    aristmk5_state,           aristmk5, ROT0, "Aristocrat", "The Chariot Challenge (04J00714, Venezuela)",          MACHINE_FLAGS, layout_snowcat )         // 630, A - 10/08/98, Rev 12
GAMEL( 2001, checkma5,    aristmk5, checkma5,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Checkmate (01J00681, NSW/ACT)",                        MACHINE_FLAGS, layout_checkma5 )        // JB011, B - 06/07/01, Rev 17
GAMEL( 1996, chickna5,    aristmk5, chickna5,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Chicken (0100351V, NSW/ACT)",                          MACHINE_FLAGS, layout_snowcat )         // 596, A - 27/08/96, Rev 1.24
GAMEL( 1998, chickna5ql,  chickna5, chickna5,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Chicken (0200530V, Queensland)",                       MACHINE_FLAGS, layout_snowcat )         // 596, C - 23/02/98, Rev 1.0
GAMEL( 1998, chickna5u,   chickna5, chickna5u,    aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Chicken (RHG0730-03, US)",                             MACHINE_FLAGS, layout_aristmk5_us )     // 596, C - 23/02/98
GAMEL( 1998, chickna5ua,  chickna5, chickna5u,    aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Chicken (RHG0730-99, US)",                             MACHINE_FLAGS, layout_aristmk5_us )     // 596, C - 23/02/98
GAMEL( 1998, coralrc2,    aristmk5, coralrc2,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Coral Riches II (0100919V, NSW/ACT)",                  MACHINE_FLAGS, layout_coralrc2 )        // 577/7, A - 29/12/98, Rev 12
GAMEL( 1998, cuckoo,      aristmk5, aristmk5,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Cuckoo (0200753V, NSW/ACT)",                           MACHINE_FLAGS, layout_aristmk5 )        // 615/1, D - 03/07/98, Rev 6
GAMEL( 2000, cuckoou,     cuckoo,   aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Cuckoo (CHG1195, US)",                                 MACHINE_FLAGS, layout_cuckoou )         // MV4104, C - 02/02/00
GAMEL( 1995, dstbloom,    aristmk5, wcougar,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Desert Bloom (0300111V, NSW/ACT)",                     MACHINE_FLAGS, layout_wcougar )         // 577/2, A - 12/10/95, Rev 1.16.4.0
GAMEL( 1995, dstblooma,   dstbloom, wcougar,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Desert Bloom (0200111V, NSW/ACT)",                     MACHINE_FLAGS, layout_wcougar )         // 577/2, A - 12/10/95, Rev 1.16.4.0
GAMEL( 1999, diamdove,    aristmk5, retrsam,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Diamond Dove (0101018V, NSW/ACT)",                     MACHINE_FLAGS, layout_sbuk3 )           // 640, B - 19/05/99, Rev 8
GAMEL( 1996, dmdfever,    aristmk5, wildbill,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Diamond Fever (0200302V, NSW/ACT)",                    MACHINE_FLAGS, layout_wildbill )        // 483/7, E - 05/09/96, Rev 1.23.5.0
GAMEL( 1997, dimtouch,    aristmk5, dimtouch,     aristmk5_touch_state,     aristmk5, ROT0, "Aristocrat", "Diamond Touch (0400433V, NSW/ACT)",                    MACHINE_FLAGS, layout_dimtouch )        // 604, E - 30/06/97, Rev 17
GAMEL( 1996, dolphntr,    aristmk5, aristmk5,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Dolphin Treasure (0200424V, NSW/ACT)",                 MACHINE_FLAGS, layout_aristmk5 )        // 602/1, B - 06/12/96, Rev 3
GAMEL( 1996, dolphntra,   dolphntr, aristmk5,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Dolphin Treasure (0100424V, NSW/ACT)",                 MACHINE_FLAGS, layout_aristmk5 )        // 602/1, B - 06/12/96, Rev 1.24.4.0
GAMEL( 1996, dolphntrb,   dolphntr, aristmk5_9,   aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Dolphin Treasure (0100388V, NSW/ACT)",                 MACHINE_FLAGS, layout_dolphntrb )       // 602, B - 10/12/96, Rev 1.24.4.0
GAMEL( 1996, dolphntru,   dolphntr, dolphntru,    aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Dolphin Treasure (FHG4077-02, US)",                    MACHINE_FLAGS, layout_aristmk5_us )     // 602/1, B - 06/12/96
GAMEL( 1999, dolphntrce,  dolphntr, dolphntrce,   aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Dolphin Treasure - Cash Express (AHG1607, US)",        MACHINE_FLAGS, layout_adonisu )         // MV4090, D - 22/12/99
GAMEL( 1999, dolphntrcea, dolphntr, dolphntru,    aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Dolphin Treasure - Cash Express (AHG1606, US)",        MACHINE_FLAGS, layout_magimaska )       // MV4090, D - 22/12/99
GAMEL( 1999, dolphntrceb, dolphntr, dolphntrce,   aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Dolphin Treasure - Cash Express (AHG1519, US)",        MACHINE_FLAGS, layout_dolphntrceb )     // MV4090, D - 22/12/99
GAMEL( 1997, drgneye,     aristmk5, snowcat,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Dragon's Eye (0100521V, NSW/ACT)",                     MACHINE_FLAGS, layout_snowcat )         // 610, A - 09/05/97, Rev 1.27
GAMEL( 1997, dreamwv,     aristmk5, dreamwv,      aristmk5_touch_state,     aristmk5, ROT0, "Aristocrat", "Dream Weaver (0200586V, NSW/ACT)",                     MACHINE_FLAGS, layout_dreamwv )         // 606/2, A - 20/06/97, Rev 16
GAMEL( 2000, dynajack,    aristmk5, dynajack,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Dynamite Jack (01J00081, NSW/ACT)",                    MACHINE_FLAGS, layout_dynajack )        // JB004, A - 12/07/2000, Rev 17
GAMEL( 1998, eldorda5,    aristmk5, reelrock,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "El Dorado (0100652V, NSW/ACT)",                        MACHINE_FLAGS, layout_reelrock )        // 623, B - 24/03/98, Rev 3
GAMEL( 1995, eforsta5,    aristmk5, swhr2,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Enchanted Forest (0400122V, NSW/ACT)",                 MACHINE_FLAGS, layout_swhr2 )           // 570/3, E - 23/06/95, Rev 1.18
GAMEL( 1997, eforsta5u,   eforsta5, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Enchanted Forest (JHG0415-03, US)",                    MACHINE_FLAGS, layout_aristmk5_us )     // MV4033, B - 10/02/97
GAMEL( 1997, eforsta5ua,  eforsta5, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Enchanted Forest (JHG0415-99, US)",                    MACHINE_FLAGS, layout_aristmk5_us )     // MV4033, B - 10/02/97
GAMEL( 2000, eforsta5cea, eforsta5, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Enchanted Forest - Cash Express (AHG1615, US)",        MACHINE_FLAGS, layout_magimaska )       // MV4108/6, C - 17/01/00
GAMEL( 1998, fastfort,    aristmk5, wildbill,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Fast Fortune (0100651V, NSW/ACT)",                     MACHINE_FLAGS, layout_wildbill )        // 624, D - 07/05/98, Rev 5
GAMEL( 2000, fortellr,    aristmk5, goldenra,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Fortune Teller (01J00131, NSW/ACT)",                   MACHINE_FLAGS, layout_fortellr )        // JB006, D - 24/11/2000, Rev 17
GAMEL( 1998, gambler,     aristmk5, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "The Gambler (EHG0916-02, US)",                         MACHINE_FLAGS, layout_aristmk5_us )     // MV4084/1, A - 30/10/98
GAMEL( 2001, geisha,      aristmk5, geisha,       aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Geisha (0101408V, New Zealand)",                       MACHINE_FLAGS, layout_geisha )          // MV4127, A - 05/03/01, Rev 25
GAMEL( 1999, genmagi,     aristmk5, genmagi,      aristmk5_touch_state,     aristmk5, ROT0, "Aristocrat", "Genie Magic (0200894V, NSW/ACT)",                      MACHINE_FLAGS, layout_genmagi )         // 632/1, C - 15/02/99, Rev 20
GAMEL( 2001, glizrdce,    aristmk5, bootsctnua,   aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Green Lizard - Cash Express (AHG1623, US)",            MACHINE_FLAGS, layout_adonisu )         // MV4112/2 - A - 05/01/01
GAMEL( 1998, gnomeatw,    aristmk5, kgalah,       aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Gnome Around The World (0100767V, NSW/ACT)",           MACHINE_FLAGS, layout_kgalah )          // 625, C - 18/12/98, Rev 16
GAMEL( 1997, goldpyr,     aristmk5, dolphntru,    aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Golden Pyramids (AHG1205-03, US)",                     MACHINE_FLAGS, layout_aristmk5_us )     // MV4091, B - 13/05/97
GAMEL( 1997, goldpyra,    goldpyr,  bootsctnua,   aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Golden Pyramids (AHG1206-99, US)",                     MACHINE_FLAGS, layout_aristmk5_us_200 ) // 602/2, B - 13/05/97
GAMEL( 1998, goldpyrb,    goldpyr,  goldpyrb,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Golden Pyramids (0100878V, Victoria)",                 MACHINE_FLAGS, layout_goldpyrb )        // 602/5, C - 19/06/98
GAMEL( 2000, goldenra,    aristmk5, goldenra,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Golden Ra (0101164V, NSW/ACT)",                        MACHINE_FLAGS, layout_goldenra )        // 661, A - 10/04/00, Rev 15
GAMEL( 2001, hnktonku,    aristmk5, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Honky Tonk (BHG1455, US)",                             MACHINE_FLAGS, layout_magimaska )       // MV4122/3, A - 07/08/01
GAMEL( 2000, honeypot,    aristmk5, goldenra,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Honey Pot (03J00241, NSW/ACT)",                        MACHINE_FLAGS, layout_yukongl5 )        // JB008, A - 21/11/2000, Rev 17
GAMEL( 1999, incasun,     aristmk5, incasun,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Inca Sun (0100872V, NSW/ACT)",                         MACHINE_FLAGS, layout_incasun )         // 631/3 B, B - 03/05/99, Rev 15
GAMEL( 1999, incasunsp,   incasun,  incasun,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Inca Sun (0100872V, NSW/ACT, Show Program)",           MACHINE_FLAGS, layout_incasun )         // 631/3 B, B - 03/05/99, Rev 15
GAMEL( 2000, incasunnz,   incasun,  incasunnz,    aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Inca Sun (0101108V, New Zealand)",                     MACHINE_FLAGS, layout_incasunnz )       // MV4113, A - 6/3/00, Rev 25
GAMEL( 2000, incasunu,    incasun,  dolphntrce,   aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Inca Sun (CHG1458, US)",                               MACHINE_FLAGS, layout_adonisu )         // MV4130/3, A - 05/09/00
GAMEL( 2000, incasunua,   incasun,  bootsctnua,   aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Inca Sun (DHG1577, US)",                               MACHINE_FLAGS, layout_adonisu )         // MV4130, A - 05/09/00
GAMEL( 1999, incasunv,    incasun,  incasun,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Inca Sun (01J01946, Venezuela)",                       MACHINE_FLAGS, layout_incasun )         // 631/3 B, B- 03/05/99, Rev 15
GAMEL( 1998, indrema5,    aristmk5, indrema5,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Indian Dreaming (0100845V, NSW/ACT)",                  MACHINE_FLAGS, layout_indrema5 )        // 628/1, B - 15/12/98, Rev 7
GAMEL( 1996, jumpjoey,    aristmk5, cashcham,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Jumpin' Joey (0100383V, NSW/ACT)",                     MACHINE_FLAGS, layout_cashcham )        // 586/6, C - 13/11/96
GAMEL( 1996, jungjuic,    aristmk5, jungjuic,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Jungle Juice (0200240V, New Zealand)",                 MACHINE_FLAGS, layout_jungjuic )        // 566/3, F - 06/03/96
GAMEL( 1995, kgalah,      aristmk5, kgalah,       aristmk5_state,           aristmk5, ROT0, "Aristocrat", "King Galah (0200536V, NSW/ACT)",                       MACHINE_FLAGS, layout_kgalah )          // 613/6, A - 21/07/95
GAMEL( 1995, kgalaha,     kgalah,   kgalah,       aristmk5_state,           aristmk5, ROT0, "Aristocrat", "King Galah (0100536V, NSW/ACT)",                       MACHINE_FLAGS, layout_kgalah )          // 613, A - 21/07/95
GAMEL( 2001, kgalahce,    kgalah,   bootsctnua,   aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "King Galah - Cash Express (AHG1625, US)",              MACHINE_FLAGS, layout_adonisu )         // MV4112/2, B - 07/02/01
GAMEL( 1994, kgbirda5,    aristmk5, kgbirda5,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "K.G. Bird (0200024V, NSW/ACT)",                        MACHINE_FLAGS, layout_kgbirda5 )        // 540/3, D - 10/10/94
GAMEL( 2001, koalamnt,    aristmk5, dolphntrce,   aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Koala Mint (CHG1573, US)",                             MACHINE_FLAGS, layout_adonisu )         // MV4137, A - 12/09/01
GAMEL( 1998, kookabuk,    aristmk5, aristmk5,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Kooka Bucks (0100677V, NSW/ACT)",                      MACHINE_FLAGS, layout_aristmk5 )        // 661, A - 03/04/98, Rev 5
GAMEL( 2000, kyhatonu,    aristmk5, bootsctnua,   aristmk5_usa_touch_state, aristmk5, ROT0, "Aristocrat", "Keep Your Hat On (BHG1204, US)",                       MACHINE_FLAGS, layout_bparty )          // MV4114/1, B - 08/05/2000
GAMEL( 1997, locoloot,    aristmk5, cashcham,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Loco Loot (0100473V, NSW/ACT)",                        MACHINE_FLAGS, layout_cashcham )        // 599/3, C - 17/06/97, Rev 1.26.13.0
GAMEL( 1997, locoloota,   locoloot, locoloota,    aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Loco Loot (0100472V, NSW/ACT)",                        MACHINE_FLAGS, layout_locoloota )       // 599/2, C - 17/06/97, Rev 1.26.13.0
GAMEL( 1998, locolootnz,  locoloot, cashchamnz,   aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Loco Loot (0600725V, New Zealand)",                    MACHINE_FLAGS, layout_cashchamnz )      // MV4064, A - 8/7/98, Rev 24
GAMEL( 2001, locolootu,   locoloot, bootsctnua,   aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Loco Loot (AHG1513, US)",                              MACHINE_FLAGS, layout_adonisu )         // MV4134, A - 30/07/01
GAMEL( 1997, lonewolf,    aristmk5, wildbill,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Lone Wolf (0100587V, NSW/ACT)",                        MACHINE_FLAGS, layout_wildbill )        // 621, A - 29/10/97, Rev 1.27.17.0
GAMEL( 1995, luckyclo,    aristmk5, wcougar,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Lucky Clover (0300109V, NSW/ACT)",                     MACHINE_FLAGS, layout_wcougar )         // 570/6, A - 12/10/95
GAMEL( 2000, magimask,    aristmk5, bootsctnua,   aristmk5_usa_touch_state, aristmk5, ROT0, "Aristocrat", "Magic Mask (AHG1549, US)",                             MACHINE_FLAGS, layout_adonisu )         // MV4115_1, A - 09/05/00
GAMEL( 2000, magimaska,   magimask, aristmk5_usa, aristmk5_usa_touch_state, aristmk5, ROT0, "Aristocrat", "Magic Mask (AHG1548, US)",                             MACHINE_FLAGS, layout_magimaska )       // MV4115, A - 09/05/00
GAMEL( 2000, magimaskb,   magimask, aristmk5_usa, aristmk5_usa_touch_state, aristmk5, ROT0, "Aristocrat", "Magic Mask (DHG1309, US)",                             MACHINE_FLAGS, layout_magimaska )       // MV4115, A - 09/05/00
GAMEL( 1997, magtcha5,    aristmk5, dimtouch,     aristmk5_touch_state,     aristmk5, ROT0, "Aristocrat", "Magic Touch (0300455V, NSW/ACT)",                      MACHINE_FLAGS, layout_dimtouch )        // 606, A - 06/03/97, Rev 14
GAMEL( 1997, magtcha5a,   magtcha5, dimtouch,     aristmk5_touch_state,     aristmk5, ROT0, "Aristocrat", "Magic Touch (0200455V, NSW/ACT)",                      MACHINE_FLAGS, layout_dimtouch )        // 606, A - 06/03/97, Rev 14
GAMEL( 1997, mammothm,    aristmk5, kgalah,       aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Mammoth Money (0100425V, NSW/ACT)",                    MACHINE_FLAGS, layout_kgalah )          // 595/5, D - 07/04/97, Rev 1.22.14.1
GAMEL( 2000, marmagic,    aristmk5, goldenra,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Margarita Magic (01J00101, NSW/ACT)",                  MACHINE_FLAGS, layout_marmagic )        // JB005, A - 07/07/00, Rev 17
GAMEL( 2000, marmagicu,   marmagic, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Margarita Magic (EHG1558, US)",                        MACHINE_FLAGS, layout_magimaska )       // US003, 07/07/2000
GAMEL( 2000, marmagicua,  marmagic, bootsctnua,   aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Margarita Magic (EHG1559, US)",                        MACHINE_FLAGS, layout_adonisu )         // US003, A - 07/07/00
GAMEL( 1997, mgarden,     aristmk5, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Magic Garden (AHG1211-99, US)",                        MACHINE_FLAGS, layout_aristmk5_us )     // MV4033, B - 10/02/97 (alt title for enchanted forest?)
GAMEL( 1996, minemine,    aristmk5, swhr2,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Mine, Mine, Mine (0400115V, NSW/ACT)",                 MACHINE_FLAGS, layout_swhr2 )           // 559/2, D - 16/01/96, Rev 1.18.3.0
GAMEL( 1996, minemineu,   minemine, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Mine, Mine, Mine (VHG0416-99, US)",                    MACHINE_FLAGS, layout_aristmk5_us )     // 559/2, E - 14/02/96
GAMEL( 1996, minemineua,  minemine, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Mine, Mine, Mine (NHG0416-99, US)",                    MACHINE_FLAGS, layout_aristmk5_us )     // 559/2, E - 14/02/96
GAMEL( 1997, monmouse,    aristmk5, cashcham,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Money Mouse (0400469V, NSW/ACT)",                      MACHINE_FLAGS, layout_cashcham )        // 607/1, B - 08/04/97, Rev 6
GAMEL( 1997, monmousea,   monmouse, cashcham,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Money Mouse (0300469V, NSW/ACT)",                      MACHINE_FLAGS, layout_cashcham )        // 607/1, B - 08/04/97, Rev 6
GAMEL( 2001, montree,     aristmk5, montree,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Money Tree (0201397V, New Zealand)",                   MACHINE_FLAGS, layout_montree )         // MV4126, C - 12/04/01, Rev 5
GAMEL( 1996, mountmon,    aristmk5, mountmon,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Mountain Money (0100294V, NSW/ACT)",                   MACHINE_FLAGS, layout_mountmon )        // 595/3, B - 11/06/96, Rev 1.22.5.0
GAMEL( 1996, mountmona,   mountmon, mystgard,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Mountain Money (0100289V, NSW/ACT)",                   MACHINE_FLAGS, layout_mystgard )        // 595/2, C - 11/06/96, Rev 1.22.5.0
GAMEL( 2001, mountmonua,  mountmon, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Mountain Money (BHG1464, US)",                         MACHINE_FLAGS, layout_magimaska )       // MV4108/5, A - 10/03/01
GAMEL( 2000, multidrw,    aristmk5, multidrw,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Multidraw - Free Games (0200956V, NSW/ACT)",           MACHINE_FLAGS, layout_multidrw )        // 386/64, E - 08/05/00, Rev 17
GAMEL( 1996, mystgard,    aristmk5, mystgard,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Mystic Garden (0100275V, NSW/ACT)",                    MACHINE_FLAGS, layout_mystgard )        // 595/1, B - 11/06/96, Rev 1.22
GAMEL( 2001, one4all,     aristmk5, one4all,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "One For All (0101503V, New Zealand)",                  MACHINE_FLAGS, layout_one4all )         // MV4141, A - 28/05/01, Rev 11
GAMEL( 1999, orchidms,    aristmk5, orchidms,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Orchid Mist (0200849V, NSW/ACT)",                      MACHINE_FLAGS, layout_orchidms )        // 601/3, C - 03/02/99, Rev 8
GAMEL( 1999, orchidmsa,   orchidms, orchidms,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Orchid Mist (0100849V, NSW/ACT)",                      MACHINE_FLAGS, layout_orchidms )        // 601/3, C - 03/02/99, Rev 6
GAMEL( 1996, oscara5,     aristmk5, aristmk5_9,   aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Oscar (0200348V, NSW/ACT)",                            MACHINE_FLAGS, layout_dolphntrb )       // 593/2, C - 20/09/96, Rev 3
GAMEL( 1996, oscara5a,    oscara5,  aristmk5_9,   aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Oscar (0100348V, NSW/ACT)",                            MACHINE_FLAGS, layout_dolphntrb )       // 593/2, C - 20/09/96, Rev 1.23.9.1
GAMEL( 1999, pantmag,     aristmk5, kgalah,       aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Panther Magic (0101046V, NSW/ACT)",                    MACHINE_FLAGS, layout_pantmag )         // 594/7, A - 06/10/99, Rev 16
GAMEL( 1999, pantmaga,    pantmag,  pantmaga,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Panther Magic (0100716V, NSW/ACT)",                    MACHINE_FLAGS, layout_pantmaga )        // 594/4, A - 13/05/98, Rev 9
GAMEL( 2001, partygrs,    aristmk5, aristmk5_usa, aristmk5_usa_touch_state, aristmk5, ROT0, "Aristocrat", "Party Gras (AHG1567, US)",                             MACHINE_FLAGS, layout_magimaska )       // MV4115/6, A - 10/11/01
GAMEL( 2001, partygrsa,   partygrs, bootsctnua,   aristmk5_usa_touch_state, aristmk5, ROT0, "Aristocrat", "Party Gras (BHG1284, US)",                             MACHINE_FLAGS, layout_bparty )          // MV4115/3, B - 06/02/01
GAMEL( 2000, peaflut,     aristmk5, trstrove,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Peacock Flutter (02J00011, NSW/ACT)",                  MACHINE_FLAGS, layout_trstrove )        // JB001, A - 10/03/00, Rev 8
GAMEL( 1997, pengpay,     aristmk5, cashchama,    aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Penguin Pays (0200460V, NSW/ACT)",                     MACHINE_FLAGS, layout_cashchama )       // 586/4(a), D - 03/06/97, Rev 3
GAMEL( 1996, pengpaya,    pengpay,  cashchama,    aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Penguin Pays (0200357V, NSW/ACT)",                     MACHINE_FLAGS, layout_cashchama )       // 586/4, C - 12/11/96
GAMEL( 1997, pengpayb,    pengpay,  swhr2,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Penguin Pays (0200359V, NSW/ACT)",                     MACHINE_FLAGS, layout_swhr2 )           // 586/3(a), D - 03/06/97, Rev 4
GAMEL( 1995, pengpayc,    pengpay,  wcougar,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Penguin Pays (0200113V, NSW/ACT)",                     MACHINE_FLAGS, layout_wcougar )         // 586, A - 12/10/95
GAMEL( 1997, pengpayu,    pengpay,  aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Penguin Pays (BHI0417-03, US)",                        MACHINE_FLAGS, layout_aristmk5_us )     // 586/7(b), B - 14/07/97
GAMEL( 1997, pengpayua,   pengpay,  aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Penguin Pays (OHG0417-03, US)",                        MACHINE_FLAGS, layout_aristmk5_us )     // 586/7(b), B - 14/07/97
GAMEL( 1997, pengpayub,   pengpay,  aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Penguin Pays (OHG0417-02, US)",                        MACHINE_FLAGS, layout_aristmk5_us )     // 586/7(b), B - 14/07/97
GAMEL( 2001, pengpayce,   pengpay,  aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Penguin Pays - Cash Express (AHG1544, US)",            MACHINE_FLAGS, layout_qnilecea )        // MV4122,  C - 19/01/01
GAMEL( 2001, pengpuck,    pengpay,  pengpuck,     aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Penguin Pays - Penguin Pucks (EHG1257, US)",           MACHINE_FLAGS, layout_pengpuck )        // MV4122/1, C - 19/01/01
GAMEL( 1998, penpir,      aristmk5, kgalah,       aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Penguin Pirate (0100674V, NSW/ACT)",                   MACHINE_FLAGS, layout_kgalah )          // 619/1, A - 31/03/98, Rev 10
GAMEL( 1998, penpira,     penpir,   snowcat,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Penguin Pirate (0200578V, NSW/ACT)",                   MACHINE_FLAGS, layout_snowcat )         // 619, A - 27/02/98, Rev 8
GAMEL( 1998, penpir2,     aristmk5, penpir2,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Penguin Pirate II (0100869V, Victoria)",               MACHINE_FLAGS, layout_penpir2 )         // 619/3, A - 17/12/98
GAMEL( 1998, petshop,     aristmk5, petshop,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Pet Shop (0100731V, NSW/ACT)",                         MACHINE_FLAGS, layout_petshop )         // 618/1, A - 17/04/98, Rev 13
GAMEL( 1995, phantpay,    aristmk5, swhr2,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Phantom Pays (0500005V, NSW/ACT)",                     MACHINE_FLAGS, layout_swhr2 )           // 570/1, E - 12/09/95
GAMEL( 1996, przfight,    aristmk5, przfight,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Prize Fight (0100299V, NSW/ACT)",                      MACHINE_FLAGS, layout_przfight )        // 578/4, B - 08/08/96
GAMEL( 1998, qcash,       aristmk5, kgalah,       aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Queens of Cash (0100706V, NSW/ACT)",                   MACHINE_FLAGS, layout_kgalah )          // 603/6, C  - 23/07/98, Rev 6
GAMEL( 1997, qnile,       aristmk5, qnile,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Queen of the Nile (0300439V, NSW/ACT)",                MACHINE_FLAGS, layout_qnile )           // 602/4, B - 13/05/97, Rev 7
GAMEL( 1997, qnilea,      qnile,    qnile,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Queen of the Nile (0200439V, NSW/ACT)",                MACHINE_FLAGS, layout_qnile )           // 602/4, B - 13/05/97, Rev 7
GAMEL( 1997, qnileb,      qnile,    qnile,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Queen of the Nile (0100439V, NSW/ACT)",                MACHINE_FLAGS, layout_qnile )           // 602/4, B - 13/05/97, Rev 1.26.18.1
GAMEL( 2002, qnilebr,     qnile,    goldpyrb,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Queen of the Nile (0101707V, Brazil)",                 MACHINE_FLAGS, layout_goldpyrb )        // MV4162, A - 21/08/02
GAMEL( 1997, qnilec,      qnile,    qnilec,       aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Queen of the Nile (0300440V, NSW/ACT)",                MACHINE_FLAGS, layout_qnilec )          // 602/3, B - 13/05/97, Rev 5
GAMEL( 1999, qniled,      qnile,    checkma5,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Queen of the Nile (0101139V, NSW/ACT)",                MACHINE_FLAGS, layout_qniled )          // 602/16, A - 11/10/99, Rev 14
GAMEL( 2000, qnilenl,     qnile,    qnilenl,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Queen of the Nile (0301059V, Holland)",                MACHINE_FLAGS, layout_qnilenl )         // 602/5, G - 10/04/00
GAMEL( 1997, qnileu,      qnile,    dolphntru,    aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Queen of the Nile (GHG4091-02, US)",                   MACHINE_FLAGS, layout_aristmk5_us )     // MV4091, B - 13/05/97
GAMEL( 1997, qnileua,     qnile,    dolphntru,    aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Queen of the Nile (GHG4091-03, US)",                   MACHINE_FLAGS, layout_aristmk5_us )     // MV4091, B - 13/05/97
GAMEL( 1997, qnilev,      qnile,    aristmk5_9,   aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Queen of the Nile (04J00784, Venezuela)",              MACHINE_FLAGS, layout_dolphntrb )       // 602/3, B - 13/05/97, Rev 6
GAMEL( 2001, qnilece,     qnile,    dolphntrce,   aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Queen of the Nile - Cash Express (AHG1609, US)",       MACHINE_FLAGS, layout_adonisu )         // MV4091/1, A - 17/01/01
GAMEL( 2001, qnilecea,    qnile,    dolphntru,    aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Queen of the Nile - Cash Express (AHG1525, US)",       MACHINE_FLAGS, layout_qnilecea )        // MV4091, F - 17/01/01
GAMEL( 2001, qnileceb,    qnile,    dolphntru,    aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Queen of the Nile - Cash Express (AHG1608, US)",       MACHINE_FLAGS, layout_magimaska )       // MV4091, F - 17/01/01
GAMEL( 1999, qnilemax,    qnile,    trstrove,     aristmk5_touch_state,     aristmk5, ROT0, "Aristocrat", "Queen of the Nile - Maximillions (0401072V, NSW/ACT)", MACHINE_FLAGS, layout_trstrove )        // 602/4, D - 18/06/99, Rev 14
GAMEL( 1994, qtbird,      aristmk5, qtbird,       aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Q.T. Bird (0500009V, NSW/ACT)",                        MACHINE_FLAGS, layout_qtbird )          // 581, A - 27/10/94, Rev 1.1.1.0
GAMEL( 2000, rainwrce,    aristmk5, adonisce,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Rainbow Warriors - Cash Express (0101332V, NSW/ACT)",  MACHINE_FLAGS, layout_aristmk5 )        // 655, B - 02/03/00, Rev 25
GAMEL( 1998, reelpwr,     aristmk5, wizways,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Reel Power (0100400V, NSW/ACT)",                       MACHINE_FLAGS, layout_wizways )         // 598/2, A - 01/11/96, Rev 1.23.8.0
GAMEL( 1998, reelrock,    aristmk5, reelrock,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Reelin-n-Rockin (0100779V, NSW/ACT)",                  MACHINE_FLAGS, layout_reelrock )        // 628, A - 13/07/98, Rev 5
GAMEL( 1997, retrsam,     aristmk5, retrsam,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Return of the Samurai (0400549V, NSW/ACT)",            MACHINE_FLAGS, layout_sbuk3 )           // 608, A - 17/04/97, Rev 5
GAMEL( 1997, retrsama,    retrsam,  retrsam,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Return of the Samurai (0200549V, NSW/ACT)",            MACHINE_FLAGS, layout_sbuk3 )           // 608, A - 17/04/97, Rev 1.26.25.3
GAMEL( 1997, retrsamb,    retrsam,  retrsamb,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Return of the Samurai (0200506V, NSW/ACT)",            MACHINE_FLAGS, layout_retrsamb )        // 608, A - 17/04/97, Rev 1.26.25.3
GAMEL( 1997, rushrst,     aristmk5, rushrst,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Rushin Rooster (0100534V, NSW/ACT)",                   MACHINE_FLAGS, layout_cashchama )       // 596/3, C - 25/06/97, Rev 1.27.2.3
GAMEL( 2001, sldeluxe,    aristmk5, bootsctnua,   aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Sweet Liberty Deluxe (AHG1575, US)",                   MACHINE_FLAGS, layout_adonisu )         // MV4137, A - 11/02/01
GAMEL( 1998, slvrwolf,    aristmk5, wamazona,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Silver Wolf (0100673V, NSW/ACT)",                      MACHINE_FLAGS, layout_wamazona )        // 621/2, A - 23/03/98, Rev 3
GAMEL( 1996, snowcat,     aristmk5, snowcat,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Snow Cat (0100405V, NSW/ACT)",                         MACHINE_FLAGS, layout_snowcat )         // 599, B - 23/12/96, Rev 1.25.1.0
GAMEL( 1997, sumospin,    aristmk5, swhr2,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Sumo Spins (0200606V, NSW/ACT)",                       MACHINE_FLAGS, layout_swhr2 )           // 622, A - 08/12/97, Rev 4
GAMEL( 1998, sbuk3,       aristmk5, sbuk3,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Super Bucks III (0200711V, NSW/ACT)",                  MACHINE_FLAGS, layout_sbuk3 )           // 626, A - 22/04/98, Rev 8
GAMEL( 1998, sbuk3a,      sbuk3,    sbuk3,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Super Bucks III (0100711V, NSW/ACT)",                  MACHINE_FLAGS, layout_sbuk3 )           // 626, A - 22/04/98, Rev 7
GAMEL( 1995, swhr2,       aristmk5, swhr2,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Sweethearts II (0200465V, NSW/ACT)",                   MACHINE_FLAGS, layout_swhr2 )           // 577/1, C - 07/09/95, Rev 3
GAMEL( 1995, swhr2a,      swhr2,    swhr2,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Sweethearts II (0200004V, NSW/ACT)",                   MACHINE_FLAGS, layout_swhr2 )           // 577/1, C - 07/09/95, Rev 1.1.3.0
GAMEL( 1998, swhr2u,      swhr2,    swhr2u,       aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Sweethearts II (PHG0742-02, US)",                      MACHINE_FLAGS, layout_swhr2u )          // MV4061, A - 29/06/98
GAMEL( 1995, swhr2v,      swhr2,    swhr2,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Sweethearts II (01J01986, Venezuela)",                 MACHINE_FLAGS, layout_swhr2 )           // 577/1, C - 07/09/95, Rev 3
GAMEL( 1996, thor,        aristmk5, cashcham,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Thor (0200319V, NSW/ACT)",                             MACHINE_FLAGS, layout_cashcham )        // 569/12, B - 14/08/96, Rev 1.23.7.0
GAMEL( 1996, thndh,       aristmk5, snowcat,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Thunder Heart (0200333V, NSW/ACT)",                    MACHINE_FLAGS, layout_snowcat )         // 570/9, A - 14/08/96, Rev 1.23.6.0
GAMEL( 1996, thndha,      thndh,    wildbill,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Thunder Heart (0200334V, NSW/ACT)",                    MACHINE_FLAGS, layout_wildbill )        // 597/1, A - 14/08/96, Rev 1.23.6.0
GAMEL( 1997, topbana,     aristmk5, wildbill,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Top Banana (0100550V, NSW/ACT)",                       MACHINE_FLAGS, layout_wildbill )        // 594/3, A - 18/08/97, Rev 1.26.39.2
GAMEL( 1998, toutango,    aristmk5, kgalah,       aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Toucan Tango (0100782V, NSW/ACT)",                     MACHINE_FLAGS, layout_kgalah )          // 616/1, A - 17/06/98, Rev 16
GAMEL( 1999, toutangonl,  toutango, toutangonl,   aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Toucan Tango (0301388V, Holland)",                     MACHINE_FLAGS, layout_toutangonl )      // 616, C - 11/05/99
GAMEL( 2000, trstrove,    aristmk5, trstrove,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Treasure Trove (01J00161, NSW/ACT)",                   MACHINE_FLAGS, layout_trstrove )        // JB001/3, A - 5/10/00, Rev 8
GAMEL( 2002, tritreat,    aristmk5, trstrove,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Triple Treat (0201692V, NSW/ACT)",                     MACHINE_FLAGS, layout_tritreat )        // 692, A - 17/05/02, Rev 25
GAMEL( 2001, trojhors,    aristmk5, goldenra,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Trojan Horse (01J00851, NSW/ACT)",                     MACHINE_FLAGS, layout_marmagic )        // JB001/5, A - 30/10/01, Rev 17
GAMEL( 1996, trpdlght,    aristmk5, swhr2,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Tropical Delight (0100269V, NSW/ACT)",                 MACHINE_FLAGS, layout_swhr2 )           // 577/3, B - 15/05/96, Rev 1.22.2.0
GAMEL( 1997, trpdlghtu,   trpdlght, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Tropical Delight (PHG0625-02, US)",                    MACHINE_FLAGS, layout_aristmk5_us )     // 577/3, D - 24/09/97
GAMEL( 1998, unicornd,    aristmk5, aristmk5,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Unicorn Dreaming (0100791V, NSW/ACT)",                 MACHINE_FLAGS, layout_aristmk5 )        // 631/1 A, A - 31/08/98, Rev 12
GAMEL( 1998, unicornda,   unicornd, aristmk5_9,   aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Unicorn Dreaming (0100813V, NSW/ACT)",                 MACHINE_FLAGS, layout_dolphntrb )       // 631 A, A - 02/09/98, Rev 14
GAMEL( 2000, unicorndnz,  unicornd, unicorndnz,   aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Unicorn Dreaming (0101228V, New Zealand)",             MACHINE_FLAGS, layout_aristmk5 )        // MV4113/1, A - 05/04/2000, Rev 27
GAMEL( 2001, unicorndu,   unicornd, bootsctnua,   aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Unicorn Dreaming (BHG1584, US)",                       MACHINE_FLAGS, layout_adonisu )         // MV4130/1, C - 10/17/01
GAMEL( 2002, venicea5,    aristmk5, goldenra,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Venice (02J02056, Venezuela)",                         MACHINE_FLAGS, layout_venicea5 )        // JB009/2, B - 11/07/02, Rev 17
GAMEL( 2001, wafricau,    aristmk5, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Wild Africa (AHG1535, US)",                            MACHINE_FLAGS, layout_magimaska )       // MV4076, B - 17/07/01
GAMEL( 1996, wamazon,     aristmk5, wamazon,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Wild Amazon (0200507V, NSW/ACT)",                      MACHINE_FLAGS, layout_wamazon )         // 506/8, A - 10/10/96, Rev 3
GAMEL( 1996, wamazona,    wamazon,  wamazona,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Wild Amazon (0200285V, NSW/ACT)",                      MACHINE_FLAGS, layout_wamazona )        // 506/6, A - 7/5/96, Rev 1.22.8.0
GAMEL( 1996, wamazonv,    wamazon,  wamazon,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Wild Amazon (01J01996, Venezuela)",                    MACHINE_FLAGS, layout_wamazon )         // 506/8, A - 10/10/96, Rev 3
GAMEL( 1997, wikwin,      aristmk5, wikwin,       aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Wicked Winnings (0100553V, NSW/ACT)",                  MACHINE_FLAGS, layout_wikwin )          // 609, B - 01/07/97, Rev 1
GAMEL( 1996, wldangel,    aristmk5, swhr2,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Wild Angels (0100337V, NSW/ACT)",                      MACHINE_FLAGS, layout_swhr2 )           // 600, B - 24/09/96
GAMEL( 1996, wildbill,    aristmk5, wildbill,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Wild Bill (0100297V, NSW/ACT)",                        MACHINE_FLAGS, layout_wildbill )        // 543/8, C - 15/08/96, Rev 1.22.12.0
GAMEL( 1996, wcougar,     aristmk5, wcougar,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Wild Cougar (0100167V, NSW/ACT)",                      MACHINE_FLAGS, layout_wcougar )         // 569/9, B - 27/2/96, Rev 1.18.1.0
GAMEL( 1997, wcougaru,    wcougar,  aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Wild Cougar (NHG0296-04, US)",                         MACHINE_FLAGS, layout_aristmk5_us )     // 569/8, D - 19/05/97
GAMEL( 1997, wcougarua,   wcougar,  aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Wild Cougar (NHG0296-07, US)",                         MACHINE_FLAGS, layout_aristmk5_us )     // 569/8, D - 19/05/97
GAMEL( 1997, wcougarub,   wcougar,  aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Wild Cougar (NHG0296-99, US)",                         MACHINE_FLAGS, layout_aristmk5_us )     // 569/8, D - 19/05/97
GAMEL( 1997, wcougaruc,   wcougar,  aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Wild Cougar (AHG1531, US)",                            MACHINE_FLAGS, layout_magimaska )       // MV4055, B - 13/05/97
GAMEL( 1996, wizways,     aristmk5, wizways,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Wizard Ways (0200396V, NSW/ACT)",                      MACHINE_FLAGS, layout_wizways )         // 598/3, A - 04/11/96, Rev 9
GAMEL( 1997, wnpost,      aristmk5, wnpost,       aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Winning Post (RHG0418-04, US)",                        MACHINE_FLAGS, layout_wnpost )          // 541/2, G - 11/02/97
GAMEL( 1999, wthing,      aristmk5, retrsam,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Wild Thing (0101158V, NSW/ACT)",                       MACHINE_FLAGS, layout_sbuk3 )           // 608/4, B - 14/12/99, Rev 8
GAMEL( 1999, wtiger,      aristmk5, wtiger,       aristmk5_state,           aristmk5, ROT0, "Aristocrat", "White Tiger Classic (0200954V, NSW/ACT)",              MACHINE_FLAGS, layout_wtiger )          // 638/1, B - 08/07/99, Rev 13
GAMEL( 2000, yukongl5,    aristmk5, goldenra,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Yukon Gold (03J00191, NSW/ACT)",                       MACHINE_FLAGS, layout_yukongl5 )        // JB005/1, A - 30/10/2000, Rev 17

// the following parent sets are known bad dumps, and do not boot (confirmed)
GAMEL( 1996, blackpnt,    aristmk5, wildbill,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Black Panther (0200818V, Victoria)",                   MACHINE_FLAGS, layout_wildbill )        // 594/1, A - 30/07/96
GAMEL( 1996, canrose,     aristmk5, bootsctnua,   aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Canyon Rose (AHG1463, US)",                            MACHINE_FLAGS, layout_cashchamu )       // 603(a), B - 06/12/96 (same as Cash Chameleon)
GAMEL( 2000, diamdest,    aristmk5, bootsctnua,   aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Diamond Destiny (AHG1533, US)",                        MACHINE_FLAGS, layout_aristmk5_us_200 ) // MV4115_5, A - 09/05/2000 (same as Magic Mask)
GAMEL( 2001, fortfvr,     aristmk5, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Fortune Fever (BHG1566, US)",                          MACHINE_FLAGS, layout_aristmk5_us )     // MV4122/2, A - 13/05/01
GAMEL( 1996, jumpbean,    aristmk5, swhr2,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Jumping Beans (0100161V, NSW/ACT)",                    MACHINE_FLAGS, layout_swhr2 )           // 586/2, A - 25/01/96
GAMEL( 1999, sbuk2,       aristmk5, sbuk2,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Super Bucks II (0400501V, NSW/ACT)",                   MACHINE_FLAGS, layout_sbuk2 )           // 578, G - 26/07/99, Rev 7
GAMEL( 2001, wcoyote,     aristmk5, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Wild Coyote (AHG1515, US)",                            MACHINE_FLAGS, layout_aristmk5_us )     // MV4134, A - 30/07/01 (same as Loco Loot)

// the following clone sets are known bad dumps, and do not boot (confirmed)
GAMEL( 2000, bpartya,     bparty,   bootsctnua,   aristmk5_usa_touch_state, aristmk5, ROT0, "Aristocrat", "Bachelorette Party (BHG1579, US)",                     MACHINE_FLAGS, layout_bparty )          // MV4119/1, B - 25/08/2000
GAMEL( 1997, cashcra5a,   cashcra5, aristmk5_9,   aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Cash Crop (0300447V, NSW/ACT)",                        MACHINE_FLAGS, layout_dolphntrb )       // 607/2, C - 29/08/97, Rev 7
GAMEL( 1996, chickna5v,   chickna5, chickna5v,    aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Chicken (01J01886, Venezuela)",                        MACHINE_FLAGS, layout_chickna5v )       // 596/1, B - 23/12/96, Rev 3
GAMEL( 2001, dynajacku,   dynajack, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Dynamite Jack (CHG1562, US)",                          MACHINE_FLAGS, layout_magimaska )       // US002, A - 11/07/01
GAMEL( 2000, eforsta5ce,  eforsta5, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Enchanted Forest - Cash Express (CHG1536, US)",        MACHINE_FLAGS, layout_aristmk5_us )     // MV4108/6, C - 17/01/00
GAMEL( 2001, mountmonce,  mountmon, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Mountain Money - Cash Express (AHG1629, US)",          MACHINE_FLAGS, layout_aristmk5_us )     // MV4108/5, A - 10/03/01
GAMEL( 2001, mountmonu,   mountmon, aristmk5_usa, aristmk5_usa_state,       aristmk5, ROT0, "Aristocrat", "Mountain Money (BHG1465, US)",                         MACHINE_FLAGS, layout_aristmk5_us )     // MV4108/5, A - 10/03/01
GAMEL( 2001, partygrsb,   partygrs, bootsctnua,   aristmk5_usa_touch_state, aristmk5, ROT0, "Aristocrat", "Party Gras (AHG1568, US)",                             MACHINE_FLAGS, layout_bparty )          // MV4115/6, A - 10/11/2001, 20 lines
GAMEL( 1995, pengpayd,    pengpay,  wcougar,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Penguin Pays (0300113V, NSW/ACT)",                     MACHINE_FLAGS, layout_wcougar )         // 586, A - 12/10/95, Rev 4
GAMEL( 1998, petshopa,    petshop,  snowcat,      aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Pet Shop (0100679V, NSW/ACT)",                         MACHINE_FLAGS, layout_snowcat )         // 618, A - 09/03/98, Rev 10
GAMEL( 1995, sbuk2a,      sbuk2,    sbuk2,        aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Super Bucks II (0300006V, NSW/ACT)",                   MACHINE_FLAGS, layout_sbuk2 )           // no data due to missing ROMs
GAMEL( 2000, wthinga,     wthing,   aristmk5,     aristmk5_state,           aristmk5, ROT0, "Aristocrat", "Wild Thing (0201176V, NSW/ACT)",                       MACHINE_FLAGS, layout_aristmk5 )        // 608/5, B - 25/02/00, Rev 11
