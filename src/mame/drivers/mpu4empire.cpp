...
DRIVER_INIT_MEMBER(mpu4_mod4oki_state,m4apachg)
{
...
GAMEL(199?, m4apachg,  0,        mpu4, mpu4_mod4oki_state, m4apachg, ROT0,   "Empire","Apache Gold (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND, layout_m4apachg )
GAMEL(199?, m4apachga, m4apachg, mpu4, mpu4_mod4oki_state, m4apachg, ROT0,   "Empire","Apache Gold (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND, layout_m4apachg )
GAMEL(199?, m4apachgb, m4apachg, mpu4, mpu4_mod4oki_state, m4apachg, ROT0,   "Empire","Apache Gold (Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND, layout_m4apachg )
GAMEL(199?, m4apachgc, m4apachg, mpu4, mpu4_mod4oki_state, m4apachg, ROT0,   "Empire","Apache Gold (Empire) (MPU4, set 4)",   GAME_FLAGS|MACHINE_NO_SOUND, layout_m4apachg )
GAMEL(199?, m4apachgd, m4apachg, mpu4, mpu4_mod4oki_state, m4apachg, ROT0,   "Empire","Apache Gold (Empire) (MPU4, set 5)",   GAME_FLAGS|MACHINE_NO_SOUND, layout_m4apachg )
GAMEL(199?, m4apachge, m4apachg, mpu4, mpu4_mod4oki_state, m4apachg, ROT0,   "Empire","Apache Gold (Empire) (MPU4, set 6)",   GAME_FLAGS|MACHINE_NO_SOUND, layout_m4apachg )
GAMEL(199?, m4apachgf, m4apachg, mpu4, mpu4_mod4oki_state, m4apachg, ROT0,   "Empire","Apache Gold (Empire) (MPU4, set 7)",   GAME_FLAGS|MACHINE_NO_SOUND, layout_m4apachg )

GAME(199?, m4bangrs,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Bangers 'n' Cash (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4bangrsa, m4bangrs, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Bangers 'n' Cash (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4bangrsb, m4bangrs, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Bangers 'n' Cash (Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4bankrd,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Bank Raid (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4bankrda, m4bankrd, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Bank Raid (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4bankrdb, m4bankrd, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Bank Raid (Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4bankrdc, m4bankrd, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Bank Raid (Empire) (MPU4, set 4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4bankrdd, m4bankrd, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Bank Raid (Empire) (MPU4, set 5)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4bigchs,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Big Cheese (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4bigchsa, m4bigchs, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Big Cheese (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4bigchsb, m4bigchs, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Big Cheese (Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4cstrik,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Cash Strike (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4cstrika, m4cstrik, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Cash Strike (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4cstrikb, m4cstrik, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Cash Strike (Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4cstrikc, m4cstrik, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Cash Strike (Empire) (MPU4, set 4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4chacec,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Chase The Ace [Cards] (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4chaceca, m4chacec, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Chase The Ace [Cards] (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4chacef,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Chase The Ace [Fruits] (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4chacefa, m4chacef, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Chase The Ace [Fruits] (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4chacefb, m4chacef, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Chase The Ace [Fruits] (Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4chacefc, m4chacef, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Chase The Ace [Fruits] (Empire) (MPU4, set 4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4crzcap,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Crazy Capers (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4crzcapa, m4crzcap, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Crazy Capers (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4crzcapb, m4crzcap, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Crazy Capers (Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4crzcapc, m4crzcap, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Crazy Capers (Empire) (MPU4, set 4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4crfire,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Crossfire (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND ) // doesn't boot, alarm
GAME(199?, m4crfirea, m4crfire, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Crossfire (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND ) // doesn't boot, alarm
GAME(199?, m4eureka,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Eureka (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4eurekaa, m4eureka, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Eureka (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4eurekab, m4eureka, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Eureka (Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4fright,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Fright Night (Empire) (MPU4, v4.1X)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4frighta, m4fright, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Fright Night (Empire) (MPU4, v4.1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4frightb, m4fright, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Fright Night (Empire) (MPU4, v4.1i)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4frightc, m4fright, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Fright Night (Empire) (MPU4, v?.?, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND ) // bad dump
GAME(199?, m4frightd, m4fright, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Fright Night (Empire) (MPU4, v3.3)",GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4frighte, m4fright, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Fright Night (Empire) (MPU4, v3.0)",GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4frightf, m4fright, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Fright Night (Empire) (MPU4, v?.?, set 2)",GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4gamblr,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","The Gambler (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4gamblra, m4gamblr, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","The Gambler (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4gamblrb, m4gamblr, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","The Gambler (Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4gtrain,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Ghost Train (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4gtraina, m4gtrain, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Ghost Train (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4gtrainb, m4gtrain, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Ghost Train (Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4gtrainc, m4gtrain, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Ghost Train (Empire) (MPU4, set 4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4goldfv,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Gold Fever (Empire) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4haunt,   0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Haunted House (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4haunta,  m4haunt,  mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Haunted House (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4hauntb,  m4haunt,  mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Haunted House (Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4hauntc,  m4haunt,  mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Haunted House (Empire) (MPU4, set 4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4hauntd,  m4haunt,  mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Haunted House (Empire) (MPU4, set 5)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4hisprt,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","High Spirits (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4hisprta, m4hisprt, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","High Spirits (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4hisprtb, m4hisprt, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","High Spirits (Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4hisprtc, m4hisprt, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","High Spirits (Empire) (MPU4, set 4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4hisprtd, m4hisprt, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","High Spirits (Empire) (MPU4, set 5)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4hisprte, m4hisprt, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","High Spirits (Empire) (MPU4, set 6)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(1996, m4hotcsh,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Hot Cash (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(1996, m4hotcsha, m4hotcsh, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Hot Cash (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(1996, m4hotcshb, m4hotcsh, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Hot Cash (Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(1996, m4hotcshc, m4hotcsh, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Hot Cash (Empire) (MPU4, set 4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4monspn,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Money Spinner (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4monspna, m4monspn, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Money Spinner (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4monspnb, m4monspn, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Money Spinner (Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4pbnudg,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Pinball Nudger (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4pbnudga, m4pbnudg, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Pinball Nudger (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4pbnudgb, m4pbnudg, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Pinball Nudger (Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4pitfal,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Pitfall (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND ) // doesn't boot, alarm
GAME(199?, m4pitfala, m4pitfal, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Pitfall (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND ) // doesn't boot, alarm
GAME(199?, m4pitfalb, m4pitfal, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Pitfall (Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND ) // doesn't boot, alarm
GAME(199?, m4pitfalc, m4pitfal, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Pitfall (Empire) (MPU4, set 4)",   GAME_FLAGS|MACHINE_NO_SOUND ) // doesn't boot, alarm
GAME(199?, m4ttrail, 0,         mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Treasure Trail (Empire) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4ttraila,m4ttrail,  mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Treasure Trail (Empire) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4ttrailb,m4ttrail,  mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","Treasure Trail (Empire) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
...
GAME(199?, m4jne,     0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Empire","The Jackpot's Not Enough (Empire) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
