...
MACHINE_CONFIG_START(skydiver_state::device_add_mconfig)
...
GAMEL(1978, skydiver, 0, skydiver, skydiver_state, 0, ROT0, "Atari", "Sky Diver", MACHINE_SUPPORTS_SAVE, layout_skydiver )
