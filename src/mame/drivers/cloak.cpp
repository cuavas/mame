...
MACHINE_CONFIG_START(cloak_state::device_add_mconfig)
...
GAME( 1983, cloak,   0,     cloak, cloak_state, 0, ROT0, "Atari", "Cloak & Dagger (rev 5)",     MACHINE_SUPPORTS_SAVE )
GAME( 1983, cloaksp, cloak, cloak, cloak_state, 0, ROT0, "Atari", "Cloak & Dagger (Spanish)",   MACHINE_SUPPORTS_SAVE )
GAME( 1983, cloakfr, cloak, cloak, cloak_state, 0, ROT0, "Atari", "Cloak & Dagger (French)",    MACHINE_SUPPORTS_SAVE )
GAME( 1983, cloakgr, cloak, cloak, cloak_state, 0, ROT0, "Atari", "Cloak & Dagger (German)",    MACHINE_SUPPORTS_SAVE )
GAME( 1983, agentx4, cloak, cloak, cloak_state, 0, ROT0, "Atari", "Agent X (prototype, rev 4)", MACHINE_SUPPORTS_SAVE )
GAME( 1983, agentx3, cloak, cloak, cloak_state, 0, ROT0, "Atari", "Agent X (prototype, rev 3)", MACHINE_SUPPORTS_SAVE )
GAME( 1983, agentx2, cloak, cloak, cloak_state, 0, ROT0, "Atari", "Agent X (prototype, rev 2)", MACHINE_SUPPORTS_SAVE )
GAME( 1983, agentx1, cloak, cloak, cloak_state, 0, ROT0, "Atari", "Agent X (prototype, rev 1)", MACHINE_SUPPORTS_SAVE )
