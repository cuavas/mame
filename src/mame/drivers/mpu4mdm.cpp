...
GAME(199?, m42punlm,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","2p Unlimited (Mdm) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4silnud,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm?","Silver Nudger (Mdm?) (MPU4)",                     GAME_FLAGS|MACHINE_NO_SOUND ) // code is close to 2p Unlimited, same sound rom
GAME(199?, m4nud2p,   0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm?","2p Nudger (Mdm?) (MPU4)",                     GAME_FLAGS|MACHINE_NO_SOUND ) // code is close to 2p Unlimited, same sound rom
GAME(199?, m4ctn,     0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm?","Tuppenny Nudger Classic (Mdm?) (MPU4)",                       GAME_FLAGS|MACHINE_NO_SOUND ) // code is close to 2p Unlimited, same sound rom
GAME(199?, m4bigapl,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","The Big Apple (Mdm) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4bigapla, m4bigapl, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","The Big Apple (Mdm) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4bigaplb, m4bigapl, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","The Big Apple (Mdm) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4bigaplc, m4bigapl, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","The Big Apple (Mdm) (MPU4, set 4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4bigapld, m4bigapl, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","The Big Apple (Mdm) (MPU4, set 5)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4bigaple, m4bigapl, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","The Big Apple (Mdm) (MPU4, set 6)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4blztrl,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Blazing Trails (Mdm) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4blztrla, m4blztrl, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Blazing Trails (Mdm) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4bodymt,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Body Match (Mdm) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND ) // doesn't boot, various alarms
GAME(199?, m4coloss,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Colossus (Mdm) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4colossa, m4coloss, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Colossus (Mdm) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4colossb, m4coloss, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Colossus (Mdm) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4colossc, m4coloss, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Colossus (Mdm) (MPU4, set 4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4colossd, m4coloss, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Colossus (Mdm) (MPU4, set 5)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4colosse, m4coloss, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Colossus (Mdm) (MPU4, set 6)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4colossf, m4coloss, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Colossus (Mdm) (MPU4, set 7)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4colossg, m4coloss, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Colossus (Mdm) (MPU4, set 8)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4firebl,  0,        mpu4, mpu4_mod2_state,    m4default, ROT0,   "Mdm","Fireball (Mdm) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND ) // hangs after spin (sound status?)
GAME(199?, m4firebla, m4firebl, mpu4, mpu4_mod2_state,    m4default, ROT0,   "Mdm","Fireball (Mdm) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND ) // hangs after spin (sound status?)
GAME(199?, m4fireblb, m4firebl, mpu4, mpu4_mod2_state,    m4default, ROT0,   "Mdm","Fireball (Mdm) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND ) // hangs after spin (sound status?)
GAME(199?, m4fireblc, m4firebl, mpu4, mpu4_mod2_state,    m4default, ROT0,   "Mdm","Fireball (Mdm) (MPU4, set 4)",   GAME_FLAGS|MACHINE_NO_SOUND ) // hangs after spin (sound status?)
GAME(199?, m4firebld, m4firebl, mpu4, mpu4_mod2_state,    m4default, ROT0,   "Mdm","Fireball (Mdm) (MPU4, set 5)",   GAME_FLAGS|MACHINE_NO_SOUND ) // hangs after spin (sound status?)
GAME(199?, m4mayhem,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Mayhem (Mdm) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4mayhema, m4mayhem, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Mayhem (Mdm) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4themob,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","The Mob (Mdm) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4themoba, m4themob, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","The Mob (Mdm) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4themobb, m4themob, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","The Mob (Mdm) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4nudbon,  0,        mpu4, mpu4_mod2_state,    m4default, ROT0,   "Mdm","Nudge Bonanza (Mdm) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4nudbona, m4nudbon, mpu4, mpu4_mod2_state,    m4default, ROT0,   "Mdm","Nudge Bonanza (Mdm) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4nudgem,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Nudge Gems (Mdm) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4smshgb,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Smash 'n' Grab (Mdm) (MPU4, set 1)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4smshgba, m4smshgb, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Smash 'n' Grab (Mdm) (MPU4, set 2)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4smshgbb, m4smshgb, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Smash 'n' Grab (Mdm) (MPU4, set 3)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4smshgbc, m4smshgb, mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Smash 'n' Grab (Mdm) (MPU4, set 4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4snklad,  0,        mpu4, mpu4_mod2_state,    m4default, ROT0,   "Mdm","Snakes & Ladders (Mdm) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4excam,   0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Excalibur (Mdm) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4front,   0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Final Frontier (Mdm) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4safar,   0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Safari Club (Mdm) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4snowbl,  0,        mpu4, mpu4_mod2_state,    m4default, ROT0,   "Mdm","Snowball Bingo (Mdm) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
GAME(199?, m4ewshft,  0,        mpu4, mpu4_mod4oki_state, m4default, ROT0,   "Mdm","Each Way Shifter (Mdm) (MPU4)",   GAME_FLAGS|MACHINE_NO_SOUND )
