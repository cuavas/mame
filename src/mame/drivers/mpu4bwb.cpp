...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4BIGMT_EXTRA_ROMS \
	ROM_END \
	GAME(year, setname, parent ,mpu4 , mpu4_mod4oki_state,m4default ,ROT0,company,title,GAME_FLAGS )
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4BLSBYS_EXTRA_ROMS \
	ROM_END \
	GAME(year, setname, parent ,mpu4 , mpu4_bwboki_state,m_blsbys ,ROT0,company,title,GAME_FLAGS )
